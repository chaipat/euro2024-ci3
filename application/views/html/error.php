...
<div id="page">
  ...
  <div>
  <a href="#"><img src="<?php echo base_url() ?>assets/images/logo-new-wc2022.png" alt=""/></a>
...
<a href="javascript:void(0)" onClick="$('.toggle').slideUp('fast');" class="close-search">x Close</a></div>
  ...
  <div class="warpper-head">
    <header class="menuhead"> <a href="#"><img src="<?php echo base_url() ?>assets/images/logo-new-wc2022.png" alt=""/></a>
    <nav>
...
<section class="warpper bg-white score-box">
    ...
    <aside class="sidebar">
        <div class="rectangle">
        <a href="https://www.ballnaja.com/" target="_blank"><img src="<?php echo base_url() ?>assets/images/banner-300x250.jpg" alt="บอลนะจ๊ะ" /></a>

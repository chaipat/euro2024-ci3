...
if($_SERVER['HTTP_HOST'] == 'localhost'){
    ...
    $config['base_url'] = 'http://localhost/euro2024/';
}else{

    if(ENVIRONMENT == 'development')
        $config['base_url'] = 'https://worldcup2022-dev.ballnaja.com/';
    else if(ENVIRONMENT == 'production')
        $config['base_url'] = 'https://worldcup2022.ballnaja.com/';    
}*/

$config['base_url'] = 'http://localhost/euro2024/';

$config['www'] = $config['base_url'];
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
